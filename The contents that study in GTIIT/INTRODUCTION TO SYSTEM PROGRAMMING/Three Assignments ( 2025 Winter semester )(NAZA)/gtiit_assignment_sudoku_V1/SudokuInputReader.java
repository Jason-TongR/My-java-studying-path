...
public class SudokuInputReader {
    ...
    public void readInput() {
        ...
        while (!validInput && !userWantsToQuit) {
            System.out.println("Enter three numbers (row, column, value) separated by spaces to place a value, or 'q' to quit:");
            ...
            if (userInput.equalsIgnoreCase("q")) {
                ...
                if (parts.length == 3) {
                    try {
                        ...
                        System.out.println("Error: Invalid input. Please enter three numbers or 'q' to quit.");
                    }
                }
                else {
                    System.out.println("Error: Please enter exactly three numbers or 'q' to quit.");
                }
            }
        }
